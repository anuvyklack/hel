...
- =gs=, =gh= and =gl= commadns are reworked: they make selections like all other
  motions, =gs= moves to the beginning of a line, =gh= moves to the beginning of a
  line skipping indentation, =gl= move to the end of a line.
...
- *Support the development*
  ...
  If you’d like to support Hel’s development, you can do so with a donation:
