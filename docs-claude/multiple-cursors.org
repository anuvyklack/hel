#+title: Multiple Cursors Guide

This guide explains how to use Hel's powerful multiple cursors functionality.

* Introduction

Multiple cursors is one of Hel's most powerful features. Unlike other
implementations, Hel's multiple cursors work seamlessly with all text editing
commands, including:
...
Hel executes commands first for the main (real) cursor, then replays them for
each fake cursor. Each cursor maintains its own:
...
*Interactive highlighting:* As you type, matching text is highlighted in
real-time.
...
Since each cursor executes commands independently, you can't directly insert
incremental numbers. However, you can:
...
- [[file:keybindings.org][Keybindings Reference]]
- [[file:customization.org][Customization Guide]]
- [[https://docs.helix-editor.com/][Helix Documentation]]
