...
- ~hel-normal-state-main-cursor~ :: Face for main cursor when Hel in Normal state.

- ~hel-insert-state-main-cursor~ :: Face for main cursor when Hel in Insert state.

- ~hel-motion-state-main-cursor~ :: Face for main cursor when Hel in Motion state.

- ~hel-normal-state-fake-cursor~ :: Face for fake cursors when Hel in Normal state.

- ~hel-insert-state-fake-cursor~ :: Face for fake cursors when Hel in Insert state.
